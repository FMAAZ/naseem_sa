    ...
    <div id="myCarousel" class="carousel slide pointer-event" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item">
                <img src="assistances/images/islands.jpg" class="d-block w-100" alt="Cinque Terre" width="550px"
                    height="555px">
            ...
            <div class="carousel-item active">
                ...
                <div class="container">
                    <div class="carousel-caption text-end">
                        <h1><span class="text-white-50">جزيرة فرسان</span></h1>
                        <p class="lead"><span class="text-decoration-underline">وجهة سياحية فريدة</span></p>
