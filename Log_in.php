  ...
  <div class="row vh-100 align-items-center justify-content-center">
    <div class="col-sm-8 col-md-6 col-lg-4 bg-transparent rounded p-4 shadow">
      ...
      <form method="POST">
        ...
        <div class="pt-1 mb-4">
          <button type="submit" class="btn btn-success w-100" name="login">تسجيل الدخول </button>
        </div>
        <p class="small mb-5 pb-lg-2"><a class="text-muted" href="password.html">نسيت كلمة المرور?</a></p>
        <p>ليس لديك حساب؟ <a href="Check_in.html" class="text-muted">سجل هنا</a</p>
      </form>
      <!-- login form -->
      <?php
