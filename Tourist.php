        ...
        <div class="container">
            <header
                ...
                <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                    <!-- Call.php -->
                    <li><a href="Call.php" class="nav-link px-2 link-success">
                    ...
                    <!-- Call.php -->
                    <!-- tourism.php -->
                    <li><a href="tourism.php" class="nav-link px-2 link-success">
                            <svg class="bi d-block mx-auto mb-1" width="24" height="24">
                                <use xlink:href="#grid" />
                            </svg>
                            الاماكن
                ...
                <div class="dropdown text-end">
                    ...
                    <ul class="dropdown-menu text-small" aria-labelledby="dropdownUser1">
                        ...
                        <li><a class="dropdown-item" href="#">عرض الطبات....</a></li>
                        <li>
