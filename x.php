    ...
    <div class="px-3 py-2 bg-white text-white">
      <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          <a href="index.html" class="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-dark text-decoration-none">
            <svg class="bi me-2" width="62" height="60" role="img" aria-label="Bootstrap"><use xlink:href="#bootstrap"/></svg>
            نسيم السعودية
          </a>

          <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
            <li>
              <a href="Call.html" class="nav-link text-success">
                <svg class="bi d-block mx-auto mb-1" width="24" height="24"><use xlink:href="#people-circle"/></svg>
                تواصل
              </a>
            </li>
            <li>
              <a href="tourism.html" class="nav-link text-success">
                <svg class="bi d-block mx-auto mb-1" width="24" height="24"><use xlink:href="#grid"/></svg>
                الاماكن السياحية
              </a>
            </li>
            <li>
              <a href="index.html" class="nav-link text-success">
...
<!--dark mode-->
 ...
 <a href="Check_in.html" class="btn btn-success">
...
<div class="container">
  <div class="row vh-100 align-items-center justify-content-center">
    <div class="col-sm-8 col-md-6 col-lg-4 bg-transparent rounded p-4 shadow">
      ...
      <form method="POST">
        ...
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="type_user" id="inlineRadio1" value="tourist"required>
          <label class="form-check-label" for="inlineRadio1">سائح</label>
        </div>
        &numsp;&numsp;
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="type_user" id="inlineRadio2" value="tour_guide" required>
          <label class="form-check-label" for="inlineRadio2">مرشد سياحي</label>
        </div>
      </div>
      <div class="mb-3">
        <div class="row g-3">
          <div class="col">
            <input type="text" class="form-control" placeholder="الاسم الأخير" aria-label="First name" name="first_name" required>
          </div>
          <div class="col">
            <input type="text" class="form-control" placeholder="الاسم الاول" aria-label="Last name" name="last_name" required>
          </div>
        </div>
      </div>
      ...
      <div class="mb-3">
        ...
        <select class="form-select" id="specificSizeSelect" name="language" required>
      ...
      <div class="col">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="gender" id="inlineRadio3" value="female"required>
          <label class="form-check-label" for="inlineRadio3"> انثى</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="gender" id="inlineRadio4" value="male"required>
          <label class="form-check-label" for="inlineRadio4"> رجل</label>
        </div>
      </div>
      </div>
      </div>
      ...
      <div class="mb-3">
        <div class="row g-3">
          <div class="col">
            ...
            <input type="number" id="age" class="form-control form-control-lg" name="age" min="18" max="99" maxlength="2" required/>
      </div>
      <div class="col">
        <label class="form-label" for="phoneNumber">رقم الهاتف</label>
            <input type="tel" id="phoneNumber" class="form-control form-control-lg" name="phone_number" min="10" max="10" placeholder="05xxxxxxxxw" required/>
      </div>
      </div>
      </div>
      <hr class="featurette-divider">
        ...
        <div class="mb-md-1">
          ...
          <input type="email" class="form-control" id="email" aria-describedby="emilHelp" name="email" required>
          <div id="emilHelp" class="form-text">ادخل ايميل صالح!!</div>
        </div>
        ...
        <div class="mb-2">
          ...
          <input type="password" class="form-control" id="password" name="check_password" required>
        </div>
        <hr class="featurette-divider">
        <div class="mb-4">
                </div>
        <button type="submit" class="btn btn-outline-info w-100" name="login_new">تسجيل </button>
      </form>
      ...
      if(isset($_POST["login_new"]) && !empty($_POST["first_name"]) && !empty($_POST["last_name"]) && !empty($_POST["email"]) && !empty($_POST["password"]) &&
        ...
        )
        {
          ...
          INSERT INTO tourist
          (
            ID , first_name , last_name , email , password , phone_number , age , gender , language
          )
          VALUES 
          (
            '.$_SESSION["new_id_tourist"].' , "'.$_POST["first_name"].'" , "'.$_POST["last_name"].'" , "'.$_POST["email"].'" , "'.$_POST["password"].'" ,
            '.$_POST["phone_number"].' , '.$_POST["age"].' , "'.$_POST["gender"].'" ,"'.$_POST["language"].'"
          )
          ');
...
<!-- button_ub-->
  ...
  <footer class="text-center text-lg-start bg-light text-muted">
    ...
    <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z"/>
        ...
        <a href="https://www.snapchat.com/add/naseem-sa?share_id=QUZCRjM4&locale=ar_SA@calendar=gregorian" class="me-4 text-reset">
    ...
    <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
      © 2021 :
      <a class="text-reset fw-bold" href="index.html">نسيم السعودية.com</a>
    </div>
    <!-- Copyright -->
  </footer>
  <!-- Footer -->
