          ...
          <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
            <li>
              <a href="Call.html" class="nav-link text-success">
                <svg class="bi d-block mx-auto mb-1" width="24" height="24"><use xlink:href="#people-circle"/></svg>تواصل
              </a>
            </li>
            <li>
              <a href="tourism.html" class="nav-link text-success">
                <svg class="bi d-block mx-auto mb-1" width="24" height="24"><use xlink:href="#grid"/></svg>  الاماكن السياحية
              </a>
            </li>
            <li>
              <a href="index.html" class="nav-link text-success">
  <svg class="bi d-block mx-auto mb-1" width="24" height="24"><use xlink:href="#home"/></svg>الرئيسية
              </a>
            </li>
          </ul>
        </div>
...
<div class="text-end">
 ...
 <a href="login_new.html" class="btn btn-success">
    ...
    <div class="col-sm-8 col-md-6 col-lg-4 bg-transparent rounded p-4 shadow">
      ...
      <form>
        <div class="mb-4">
          ...
          <input type="email" class="form-control" id="email" aria-describedby="emilHelp"required>
          <div id="emilHelp" class="form-text">ادخل ايميل صالح!!</div>
        </div>
        <button type="submit" class="btn btn-success w-100">ارسال</button>
      </form>
      <p class="mb-0 text-center">العودة <a href="Log_in.html"class="text-muted"> : تسجيل الدخول</a></p>
    </div>
  </div>
</div>
    <!-- form -->
